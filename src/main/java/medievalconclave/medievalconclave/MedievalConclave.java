...
import medievalconclave.medievalconclave.effect.ArmorPiercingEffect;
...
public class MedievalConclave {
    ...
    public static ResourceLocation identifier(String path) {
        return new ResourceLocation("medievalconclave", path);
    }
...
//        CustomEntityActions.register();
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo("medievalconclave", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
